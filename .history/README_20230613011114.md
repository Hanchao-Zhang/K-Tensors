...
+ Go to the terminal (mac) or command line (windows), copy and paste:`pip3 install KTensors`
...
+ Open a python console, copy and paste: `import KTensors as kt`
...
For more technical details, please refer to the paper: [Clustering Positive Definite Matrices via Low Rank Representation](https://arxiv.org/abs/2306.06534) 
